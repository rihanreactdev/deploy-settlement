...
function Main() {
    ...
    return (
      <div>
          ...
          <div id="features" className="features-area cell-items default-padding about-area" style={{backgroundColor: "rgb(103, 185, 83, 0.2)"}}>
              <div className="container">
                  <div className="row">
                  ...
                  <div className="row">
                      ...
                      <div className="col-lg-7 features-items  services-info">
                          <div className="row">
                              <div className="col-lg-6 col-md-6">
                                  <div className="item">
                                      <div className="info">
                              ...
                              <div className="accordion" id="accordionExample">
                                  <div className="card">
                                      <div className="card-header" id="headingOne">
                                          ...
                                          >
                                              What do you mean by "Online Dispute Resolution"?
                                          </h4>
                                      </div>
                                  ...
                                  <div className="card">
                                      <div className="card-header" id="headingFour">
                                          <h4
                                            ...
                                            aria-controls="collapseFour"
                                          >
                                              What will be the cost/fee for the process?
                                          </h4>
                                      </div>
                                      <div
                                        id="collapseFour"
